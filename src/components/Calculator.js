    ...
    return (
      <section className="calculator-container">
        ...
        <div className="calculator-keyboard">
          ...
          <button type="button" className="button" onClick={this.handleClick}>%</button>
          <button type="button" className="button orange" onClick={this.handleClick}>÷</button>
          ...
          <button type="button" className="button orange" onClick={this.handleClick}>x</button>
          ...
          <button type="button" className="button orange" onClick={this.handleClick}>+</button>
          <button type="button" className="button zero" onClick={this.handleClick}>0</button>
          <button type="button" className="button" onClick={this.handleClick}>.</button>
          <button type="button" className="button orange" onClick={this.handleClick}>=</button>
        </div>
      </section>
